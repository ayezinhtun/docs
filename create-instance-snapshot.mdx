...
<Frame>
  ![Create Volume Snapshot 1](/images/create-volume-snapshot-1.png)
</Frame>
...
<Frame>
  ![Snapshot Select Location](/images/snapshot-select-location.png)
</Frame>
...
<Frame>
  ![Stackconsole Create Block Storages Select Project](/images/stackconsole-create-block-storages-select-project.png)
</Frame>
...
<Frame>
  ![Choose Instance Or Volume](/images/choose-instance-or-volume.png)
</Frame>
...
<Frame>
  ![Vm Snapshot Name](/images/vm-snapshot-name.png)
</Frame>
...
<Frame>
  ![Review And Create Snapshot](/images/review-and-create-snapshot.png)
</Frame>
