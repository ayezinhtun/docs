...
<Frame>
  ![Assign Project](/images/assign-project.png)
</Frame>
...
<Frame>
  ![Stackconsole Create Block Storages Select Instance](/images/stackconsole-create-block-storages-select-instance.png)
</Frame>
...
<Frame>
  ![Choose Volume Size](/images/choose-volume-size.png)
</Frame>
...
<Frame>
  ![Choose Name](/images/choose-name.png)
</Frame>
...
<Frame>
  ![Submit Volume](/images/submit-volume.png)
</Frame>
