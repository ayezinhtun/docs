...
<Frame>
  ![Vnf Appliances](/images/vnf-appliances.png)
</Frame>
...
<Frame>
  ![Vnf Choose Location](/images/vnf-choose-location.png)
</Frame>
...
<Frame>
  ![Vnf Choose Image](/images/vnf-choose-image.png)
</Frame>
...
<Frame>
  ![Vnf Choose Plan](/images/vnf-choose-plan.png)
</Frame>
...
<Frame>
  ![Vnf Choose Project](/images/vnf-choose-project.png)
</Frame>
...
<Frame>
  ![Vnf Choose Network](/images/vnf-choose-network.png)
</Frame>
...
<Frame>
  ![Vnf Public Ip](/images/vnf-public-ip.png)
</Frame>
...
<Frame>
  ![Vnf Affinity Group](/images/vnf-affinity-group.png)
</Frame>
...
<Frame>
  ![Vnf Server Settings](/images/vnf-server-settings.png)
</Frame>

- Add the name of the SSH key with the key value and click on **Add SSH Key**.

<Frame>
  ![Vnf Add Ssh Key](/images/vnf-add-ssh-key.png)
</Frame>
...
<Frame>
  ![Vnf Server Setting](/images/vnf-server-setting.png)
</Frame>
...
<Frame>
  ![Vnf Advanced Mode](/images/vnf-advanced-mode.png)
</Frame>
...
<Frame>
  ![Vnf Server Hostname](/images/vnf-server-hostname.png)
</Frame>
...
<Frame>
  ![Vnf Billing Circle](/images/vnf-billing-circle.png)
</Frame>
