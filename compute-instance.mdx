...
<Frame>
  ![Compute Instance Choose Image](/images/compute-instance-choose-image.jpg)
</Frame>
...
<Frame>
  ![Stackconsole Create Instance Enable Public Ip](/images/stackconsole-create-instance-enable-public-ip.png)
</Frame>
...
<Frame>
  ![Stackconsole Create Instance Add Ssh](/images/stackconsole-create-instance-add-ssh.png)
</Frame>

- Add the name of the SSH key with the key value and click **Add SSH Key**.

<Frame>
  ![Add Sshkey](/images/add-sshkey.png)
</Frame>
...
<Frame>
  ![Stackconsole Create Instance Add Startup Script 1](/images/stackconsole-create-instance-add-startup-script-1.png)
</Frame>
...
<Frame>
  ![Advanced Mode 1](/images/advanced-mode-1.png)
</Frame>
...
<Frame>
  ![Billing Circle](/images/billing-circle.png)
</Frame>
